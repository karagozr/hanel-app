...
import { Form, SimpleItem, Label, RangeRule, RequiredRule, Item } from 'devextreme-react/form';
import DataGrid, {Column, Editing, Paging, Lookup,Summary, TotalItem } from 'devextreme-react/data-grid';
import {TextBox,  Button as TextBoxButton } from 'devextreme-react/text-box';
import { Button } from 'devextreme-react/button';
import { confirm } from 'devextreme/ui/dialog';

import {useGuide, useInvoice } from '../../contexts/hooks'
import { CariGuide, HesapKodLookUp, StokLookUpGuide } from '../../components'
...
export const InvoiceEdit = React.memo(({invoiceGuid}) => {
    ...
    const buttons = window.innerWidth>1080?[]: [{ icon: 'save', label: 'Kaydet', clickEvent: HandleSaveClick },{ icon: 'orderedlist', label: 'Yevmiye Fişi', clickEvent: openYevmiyeFisi }];
    ...
    return (
        <div>
            ...
            <form id="mainForm" key="mainEditForm">
                ...
                <Form showColonAfterLabel={false} id={'formId'}
                    showValidationSummary={true} scrollingEnabled={false} colCount={3} formData={formData} >
                    ...
                    <SimpleItem colSpan={2} dataField="cariKodu" editorOptions={{ value: formData.subeKodu,
                    ...
                    <SimpleItem colSpan={3} dataField="aciklama" >
                        <Label showColon={true} location={'top'} text="Açıklama - 1" />
                    </SimpleItem>
                    <SimpleItem colSpan={3} dataField="aciklama2" >
                    ...
                    <Item colSpan={3}>
                        <div id='grid-content' style={{ width: '100%' }}>
                            ...
                            <DataGrid
                                ...
                                <Column dataField="kdvTutar" caption="Kdv Tutar" dataType='number' format={{ type: "fixedPoint", precision: 2 }} >
                                    <RequiredRule />
                                    <RangeRule min={0.0} />
                                </Column>
