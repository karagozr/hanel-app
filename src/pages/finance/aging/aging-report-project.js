...
export const AgingReportProject = ({filter}) => {
    //let datasource = getMasterDetailGridDataSource();
    ...
    const fetchData = async () =>{
        var res = await aging.getReportProject(filter);
        setData(res.data);
    } 
    ...
    return (
        <React.Fragment>
                ...
                >
                    ...
                    <Column cellRender={cellRender} dataField="projeKodu" caption="Proje Kodu" dataType="string" />
                    <Column cellRender={cellRender} dataField="projeAdi" caption="Proje" dataType="string" />
