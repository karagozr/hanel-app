...
export const PlReportDetailModal = ({ open, onClose, dataSource }) => {
    const modal = useRef();
        ...
        <Popup
            ...
            <div id={"modal-content"} style={{ height: '100%' }}>
                ...
                >
                    ...
                    <Column tabIndex={-1} dataField={'branchName'} caption={'Şube'} dataType={'string'} cssClass={"column"} />
                    <Column tabIndex={-1} dataField={'description'} caption={'Açıklama'} dataType={'string'} cssClass={"column"} />
                    <Column tabIndex={-1} dataField={'integrationCode'} caption={'P&L Kodu'} dataType={'string'} cssClass={"column"} />
                    <Column tabIndex={-1} dataField={'integrationDesc'} caption={'P&L Açıklama'} dataType={'string'} cssClass={"column"} />
                    <Column tabIndex={-1} dataField={'projectCode'} caption={'Prj. Kodu'} dataType={'string'} cssClass={"column"} />
                    <Column tabIndex={-1} dataField={'projectName'} caption={'Prj. Adı'} dataType={'string'} cssClass={"column"} />
